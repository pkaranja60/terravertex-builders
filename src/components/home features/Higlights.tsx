  ...
  return (
    <>
      ...
      <div className="w-full flex items-center pt-28 pb-28 gap-20 bg-[#643404] px-16 text-white">
        <div className="w-1/2">
          <p className="font-semibold mb-4">strength</p>
      ...
      {/* Discovery Section */}
      <div className="w-full flex items-center pt-28 pb-28 gap-20 bg-[#0D0701] px-16"></div>

      {/* Why choose US */}
      <div className="w-full flex items-center pt-28 pb-28 gap-20 bg-[#643404] px-16"></div>
    </>
  );
}
